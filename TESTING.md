...
| As a user, I want to view a summary of the items in my shopping cart so that I can review my order before proceeding to checkout. | The user can view a summary of the items in their shopping cart. | Pass |
