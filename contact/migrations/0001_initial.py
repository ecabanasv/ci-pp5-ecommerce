    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subject', models.CharField(max_length=100, validators=[django.core.validators.RegexValidator(message='Subject contains invalid characters', regex="^[a-zA-Z0-9\\s\\-\\_\\.\\,\\!\\?\\']+")])),
