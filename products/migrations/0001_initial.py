# Generated by Django 3.2 on 2023-03-22 20:10
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, validators=[django.core.validators.RegexValidator(code='invalid_author_description', message='Description contains invalid characters', regex='^[a-zA-Z0-9\\s\\-\\_\\.\\,\\;\\:\\\'\\"\\(\\)\\[\\]\\{\\}\\@\\#\\$\\%\\&\\*\\+\\=\\?\\/\\!\\^\\|\\~\\`\\\\]+$')])),
            ],
        ),
        migrations.CreateModel(
            name='Category',
            fields=[
                ...
                ('description', models.TextField(blank=True, null=True, validators=[django.core.validators.RegexValidator(code='invalid_category_description', message='Description contains invalid characters', regex='^[a-zA-Z0-9\\s\\-\\_\\.\\,\\;\\:\\\'\\"\\(\\)\\[\\]\\{\\}\\@\\#\\$\\%\\&\\*\\+\\=\\?\\/\\!\\^\\|\\~\\`\\\\]+$')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, validators=[django.core.validators.RegexValidator(code='invalid_publisher_description', message='Description contains invalid characters', regex='^[a-zA-Z0-9\\s\\-\\_\\.\\,\\;\\:\\\'\\"\\(\\)\\[\\]\\{\\}\\@\\#\\$\\%\\&\\*\\+\\=\\?\\/\\!\\^\\|\\~\\`\\\\]+$')])),
            ],
        ),
        migrations.CreateModel(
            name='SubCategory',
            fields=[
                ...
                ('description', models.TextField(blank=True, null=True, validators=[django.core.validators.RegexValidator(code='invalid_subcategory_description', message='Description contains invalid characters', regex='^[a-zA-Z0-9\\s\\-\\_\\.\\,\\;\\:\\\'\\"\\(\\)\\[\\]\\{\\}\\@\\#\\$\\%\\&\\*\\+\\=\\?\\/\\!\\^\\|\\~\\`\\\\]+$')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('small_description', models.CharField(blank=True, max_length=200, null=True, validators=[django.core.validators.RegexValidator(code='invalid_small_description', message='Small description contains invalid characters', regex='^[a-zA-Z0-9\\s\\-\\_\\.\\,\\;\\:\\\'\\"\\(\\)\\[\\]\\{\\}\\@\\#\\$\\%\\&\\*\\+\\=\\?\\/\\!\\^\\|\\~\\`\\\\]+$')])),
                ('description', models.TextField(blank=True, max_length=500, validators=[django.core.validators.RegexValidator(code='invalid_description', message='Description contains invalid characters', regex='^[a-zA-Z0-9\\s\\-\\_\\.\\,\\;\\:\\\'\\"\\(\\)\\[\\]\\{\\}\\@\\#\\$\\%\\&\\*\\+\\=\\?\\/\\!\\^\\|\\~\\`\\\\]+$')])),
